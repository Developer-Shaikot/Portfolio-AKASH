                ...
                <div className="py-5 ml-2">
                    ...
                    <FooterCol key={4} menuTitle="" menuItems={MyAddress}> 
                        <ul className="social-media list-inline">
                            <li className="list-inline-item"><a href="https://www.facebook.com/saikat.akash1/" target="_blank"><FontAwesomeIcon className="icon" icon={faFacebookF} /></a></li>
                        ...
                        <div className="mt-5">
                            ...
                            <br/>
                            <br/>
                            <Button variant="outline-info" size="lg mb-2"> <a className="db" href="tel:+8801833440993" target="_blank"><CallIcon></CallIcon>+8801833440993</a></Button>
                        </div>
                    </FooterCol>
                </div>
